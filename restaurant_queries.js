...
for these queries to filter the returned fields to only those fields described in each problem.
...
Find all the names and addresses of all the restaurants in Manhattan that are not a Bakery, Spanish,
  Italian or Irish
...
try out $unwind to get used to what it does.Execute the following queries in your MongoDB shell:
